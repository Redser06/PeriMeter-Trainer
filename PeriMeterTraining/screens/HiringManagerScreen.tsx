...
const HiringManagerScreen: React.FC = () => {
  const { users, objectives, userObjectives } = useContext(AppContext);

  const trainees = useMemo(() => {
    return users.filter(u => u.roles.includes('Trainee')).map(trainee => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 flex flex-col justify-center">
